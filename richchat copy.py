...
st.session_state.setdefault(
    'past',
    [
        # 'plan text with line break', 'play the song "Dancing Vegetables"',
        # 'show me image of cat', 'and video of it', 'show me some markdown sample',
        # 'table in markdown'
    ])
st.session_state.setdefault(
    'generated',
    [
        ...
        # {
        #     'type': 'normal',
        #     'data': f'<audio controls src="{audio_path}"></audio>'
        # },
        #{
        #     'type': 'normal',
        ...
        # }, {
        #     'type': 'normal',
        #     'data': f'{youtube_embed}'
        # }, {
        #     'type': 'normal',
        #     'data': f'{markdown}'
        # }, {
        #     'type': 'table',
        #     'data': f'{table_markdown}'
        # }
    ])
